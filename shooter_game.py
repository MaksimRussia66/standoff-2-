...
for i in range(4):
    monster = Enemy('ufo.png', randint(80, width - 80), -40, 80, 50, randint(1,3))
    monsters.add(monster)

asteroids = sprite.Group()
for i in range(2):
    asteroid = Asteroid('asteroid.png', randint(80, width - 80), -40, 80, 50, randint(1,5))
...
while game:
    ...
    if not finish:
        ...
        for c in collides:
            c.life -= 1
            if len(asteroids) < 3:
                asteroid = Asteroid("asteroid.png", randint(80, width - 80), -40, 80, 50, randint(1,3))
                asteroids.add(asteroid)
